use droas_bot::image::{
    ContrastCalculator, ImageRenderer, RgbColor, WelcomeImageConfig, WELCOME_IMAGE_HEIGHT,
    WELCOME_IMAGE_WIDTH,
};
use std::sync::Arc;
...
async fn test_nfr_sc001_concurrent_rendering() {
    ...
    .await
    .expect("Concurrent rendering test timed out");
