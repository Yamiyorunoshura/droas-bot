...
mod tests {
    ...
    fn test_background_asset_validation() {
        // 測試支持的圖片格式
        let png_asset = BackgroundAsset::new(
            "test".to_string(),
            "test.png".to_string(),
            "image/png".to_string(),
            1000,
        ...
        let jpeg_asset = BackgroundAsset::new(
            "test".to_string(),
            "test.jpg".to_string(),
        ...
        let jpg_asset = BackgroundAsset::new(
            "test".to_string(),
            "test.jpg".to_string(),
            "image/jpg".to_string(),
            1000,
        ...
        // 測試不支持的格式
        let gif_asset = BackgroundAsset::new(
            "test".to_string(),
            "test.gif".to_string(),
            "image/gif".to_string(),
            1000,
        ...
        // 測試文件大小限制
        let valid_size = BackgroundAsset::new(
            "test".to_string(),
            "test.png".to_string(),
            "image/png".to_string(),
            1024 * 1024,
        ...
        let too_large = BackgroundAsset::new(
            "test".to_string(),
            "test.png".to_string(),
            "image/png".to_string(),
            6 * 1024 * 1024,
        ...
        let zero_size = BackgroundAsset::new(
            "test".to_string(),
            "test.png".to_string(),
            "image/png".to_string(),
            0,
