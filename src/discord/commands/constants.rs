...
pub mod image {
    ...
    /// 支援的MIME類型
    pub const SUPPORTED_MIME_TYPES: &[&str] = &["image/png", "image/jpeg", "image/jpg"];
}
...
pub mod security {
    /// 禁止的主機名稱
    pub const FORBIDDEN_HOSTS: &[&str] = &["localhost", "127.0.0.1", "0.0.0.0", "::1"];
...
pub mod discord {
    ...
    /// 用戶頭像URL模板
    pub const AVATAR_URL_TEMPLATE: &str =
        "https://cdn.discordapp.com/avatars/{user_id}/{avatar_hash}.png?size=256";

    /// 默認頭像URL模板
    pub const DEFAULT_AVATAR_URL_TEMPLATE: &str =
