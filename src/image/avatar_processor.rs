...
use crate::image::{WelcomeImageResult, WelcomeImageError};
...
impl AvatarProcessor {
    ...
    pub fn process_avatar(
        ...
        let square_avatar = avatar_image.resize_exact(
            diameter,
            diameter,
    ...
    fn apply_circular_mask(&self, image: &RgbaImage, diameter: u32) -> WelcomeImageResult<RgbaImage> {
    ...
    pub fn create_default_avatar(&self, diameter: u32, bg_color: Rgba<u8>) -> WelcomeImageResult<ProcessedAvatar> {
        ...
        for y in 0..avatar.diameter {
            for x in 0..avatar.diameter {
                ...
                if avatar_pixel[3] > 0 {
                    ...
                    target_pixel[0] = (avatar_pixel[0] as f32 * alpha + target_pixel[0] as f32 * inv_alpha) as u8;
                    target_pixel[1] = (avatar_pixel[1] as f32 * alpha + target_pixel[1] as f32 * inv_alpha) as u8;
                    target_pixel[2] = (avatar_pixel[2] as f32 * alpha + target_pixel[2] as f32 * inv_alpha) as u8;
                    target_pixel[3] = ((avatar_pixel[3] as f32 + target_pixel[3] as f32 * inv_alpha).min(255.0)) as u8;
                }
            }
        }
